# Generated by Django 5.1.7 on 2025-07-10 15:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='quizApp.studenttest')),
            ],
        ),
        migrations.CreateModel(
            name='Test',
            fields=[
                ...
                ('allowed_students', models.ManyToManyField(blank=True, related_name='assigned_tests', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='question',
            name='test',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='quizApp.test'),
        ),
